...
namespace Calendar_with_jokes {
    ...
    public partial class CalendarDataSet : global::System.Data.DataSet {
        ...
        public partial class EventsDataTable : global::System.Data.TypedTableBase<EventsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EventsRow AddEventsRow(System.DateTime Date, string Kind, string Name, string Description) {
        ...
        public partial class EventsRow : global::System.Data.DataRow {
            ...
            public string Kind {
                get {
                    try {
                        return ((string)(this[this.tableEvents.KindColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Kind\' in table \'Events\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableEvents.KindColumn] = value;
                }
            }
            ...
            public bool IsKindNull() {
                return this.IsNull(this.tableEvents.KindColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetKindNull() {
                this[this.tableEvents.KindColumn] = global::System.Convert.DBNull;
            }
...
namespace Calendar_with_jokes.CalendarDataSetTableAdapters {
    ...
    public partial class EventsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Events] WHERE (([EventID] = @Original_EventID) AND ([Date] = @Original_Date) AND ((@IsNull_Kind = 1 AND [Kind] IS NULL) OR ([Kind] = @Original_Kind)) AND ([Name] = @Original_Name) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Events] ([Date], [Kind], [Name], [Description]) VALUES (@Date," +
                " @Kind, @Name, @Description);\r\nSELECT EventID, Date, Kind, Name, Description FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Events] SET [Date] = @Date, [Kind] = @Kind, [Name] = @Name, [Description] = @Description WHERE (([EventID] = @Original_EventID) AND ([Date] = @Original_Date) AND ((@IsNull_Kind = 1 AND [Kind] IS NULL) OR ([Kind] = @Original_Kind)) AND ([Name] = @Original_Name) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)));
SELECT EventID, Date, Kind, Name, Description FROM Events WHERE (EventID = @EventID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Calendar_with_jokes.Properties.Settings.Default.CalendarConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EventID, Date, Kind, Name, Description FROM dbo.Events";
        ...
        public virtual int Fill(CalendarDataSet.EventsDataTable dataTable) {
        ...
        public virtual CalendarDataSet.EventsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CalendarDataSet.EventsDataTable dataTable = new CalendarDataSet.EventsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CalendarDataSet.EventsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_EventID, System.DateTime Original_Date, string Original_Kind, string Original_Name, string Original_Description) {
        ...
        public virtual int Insert(System.DateTime Date, string Kind, string Name, string Description) {
        ...
        public virtual int Update(System.DateTime Date, string Kind, string Name, string Description, int Original_EventID, System.DateTime Original_Date, string Original_Kind, string Original_Name, string Original_Description, int EventID) {
            ...
            if ((Original_Kind == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Kind));
            }
            if ((Original_Name == null)) {
                throw new global::System.ArgumentNullException("Original_Name");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime Date, string Kind, string Name, string Description, int Original_EventID, System.DateTime Original_Date, string Original_Kind, string Original_Name, string Original_Description) {
            return this.Update(Date, Kind, Name, Description, Original_EventID, Original_Date, Original_Kind, Original_Name, Original_Description, Original_EventID);
        }
    }
